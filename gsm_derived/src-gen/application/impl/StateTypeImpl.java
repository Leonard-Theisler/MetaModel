 ...
 * </p>
 * <ul>
 *   <li>{@link application.impl.StateTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link application.impl.StateTypeImpl#getInitial <em>Initial</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateTypeImpl extends MinimalEObjectImpl.Container implements StateType {
	...
	protected EClass eStaticClass() {
		return Gsm_derivedPackage.Literals.STATE_TYPE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsm_derivedPackage.STATE_TYPE__ID, oldId, id));
	}
	...
	public void setInitial(String newInitial) {
		...
		initial = newInitial;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsm_derivedPackage.STATE_TYPE__INITIAL, oldInitial,
					initial));
	}
