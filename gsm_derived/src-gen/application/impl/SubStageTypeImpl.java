...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sub Stage Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link application.impl.SubStageTypeImpl#getDataFlowGuard <em>Data Flow Guard</em>}</li>
 *   <li>{@link application.impl.SubStageTypeImpl#getMilestone <em>Milestone</em>}</li>
 *   <li>{@link application.impl.SubStageTypeImpl#getSubStage <em>Sub Stage</em>}</li>
 *   <li>{@link application.impl.SubStageTypeImpl#getTask <em>Task</em>}</li>
 *   <li>{@link application.impl.SubStageTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link application.impl.SubStageTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link application.impl.SubStageTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link application.impl.SubStageTypeImpl#getProcessFlowGuard <em>Process Flow Guard</em>}</li>
 *   <li>{@link application.impl.SubStageTypeImpl#getFaultLogger <em>Fault Logger</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubStageTypeImpl extends MinimalEObjectImpl.Container implements SubStageType {
	/**
	...
	public void setSubstage(SubStageType sub) {
		subStage.add(sub);
	}
	...
	protected EClass eStaticClass() {
		return Gsm_derivedPackage.Literals.SUB_STAGE_TYPE;
	}
	...
	public EList<DataFlowGuardType> getDataFlowGuard() {
		if (dataFlowGuard == null) {
			dataFlowGuard = new EObjectContainmentEList<DataFlowGuardType>(DataFlowGuardType.class, this,
					Gsm_derivedPackage.SUB_STAGE_TYPE__DATA_FLOW_GUARD);
		}
	...
	public EList<MilestoneType> getMilestone() {
		if (milestone == null) {
			milestone = new EObjectContainmentEList<MilestoneType>(MilestoneType.class, this,
					Gsm_derivedPackage.SUB_STAGE_TYPE__MILESTONE);
		}
		return milestone;
	}
	...
	public EList<SubStageType> getSubStage() {
		if (subStage == null) {
			subStage = new EObjectContainmentEList<SubStageType>(SubStageType.class, this,
					Gsm_derivedPackage.SUB_STAGE_TYPE__SUB_STAGE);
		}
		return subStage;
	}
	...
	public NotificationChain basicSetTask(TaskType newTask, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Gsm_derivedPackage.SUB_STAGE_TYPE__TASK, oldTask, newTask);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newTask != task) {
			...
			if (task != null)
				msgs = ((InternalEObject) task).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Gsm_derivedPackage.SUB_STAGE_TYPE__TASK, null, msgs);
			if (newTask != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Gsm_derivedPackage.SUB_STAGE_TYPE__TASK, newTask,
					newTask));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsm_derivedPackage.SUB_STAGE_TYPE__DESCRIPTION,
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsm_derivedPackage.SUB_STAGE_TYPE__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsm_derivedPackage.SUB_STAGE_TYPE__NAME, oldName,
					name));
	}
	...
	public EList<ProcessFlowGuardType> getProcessFlowGuard() {
		if (processFlowGuard == null) {
			processFlowGuard = new EObjectContainmentEList<ProcessFlowGuardType>(ProcessFlowGuardType.class, this,
					Gsm_derivedPackage.SUB_STAGE_TYPE__PROCESS_FLOW_GUARD);
		}
	...
	public EList<FaultLoggerType> getFaultLogger() {
		if (faultLogger == null) {
			faultLogger = new EObjectContainmentEList<FaultLoggerType>(FaultLoggerType.class, this,
					Gsm_derivedPackage.SUB_STAGE_TYPE__FAULT_LOGGER);
		}
		return faultLogger;
	}
