 ...
 * </p>
 * <ul>
 *   <li>{@link application.impl.OutputTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link application.impl.OutputTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link application.impl.OutputTypeImpl#getRootElement <em>Root Element</em>}</li>
 *   <li>{@link application.impl.OutputTypeImpl#getSchemaUri <em>Schema Uri</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputTypeImpl extends MinimalEObjectImpl.Container implements OutputType {
	...
	protected EClass eStaticClass() {
		return Gsm_derivedPackage.Literals.OUTPUT_TYPE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsm_derivedPackage.OUTPUT_TYPE__VALUE, oldValue,
					value));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsm_derivedPackage.OUTPUT_TYPE__ID, oldId, id));
	}
	...
	public void setRootElement(String newRootElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsm_derivedPackage.OUTPUT_TYPE__ROOT_ELEMENT,
	...
	public void setSchemaUri(String newSchemaUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gsm_derivedPackage.OUTPUT_TYPE__SCHEMA_URI,
