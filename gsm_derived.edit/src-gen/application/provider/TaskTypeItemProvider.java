...
/**
 * This is the item provider adapter for a {@link application.TaskType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskTypeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TaskType_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TaskType_id_feature", "_UI_TaskType_type"),
						Gsm_derivedPackage.Literals.TASK_TYPE__ID, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_TaskType_name_feature",
								"_UI_TaskType_type"),
						Gsm_derivedPackage.Literals.TASK_TYPE__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Gsm_derivedPackage.Literals.TASK_TYPE__ASSIGN);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_TaskType_type")
	...
	public void notifyChanged(Notification notification) {
		...
		case Gsm_derivedPackage.TASK_TYPE__ID:
		case Gsm_derivedPackage.TASK_TYPE__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case Gsm_derivedPackage.TASK_TYPE__ASSIGN:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Gsm_derivedPackage.Literals.TASK_TYPE__ASSIGN,
				Gsm_derivedFactory.eINSTANCE.createAssignType()));
	}
